...
- [x] **TEST-04**: Security negative-case suite: user without read access to an entity receives filtered schema AND execution is denied; RAG retrieval filters out forbidden roles; cross-user conversation access denied *(Phase 08-01 landed 6 @Test methods; Phase 08-08 replan-2 closed Gap 1 by wiring jmix-security-data-starter and broadening UnconstrainedDataManager scope to 4 production sites + 8 test files — 12/12 GREEN in com.vn.agent.security.*, 236/236 broad broom BUILD SUCCESSFUL)*
