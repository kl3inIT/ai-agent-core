...
**Wave 1**
- [ ] 12-01-PLAN.md — Scope-doc amendments + `AiChatSurface` / `AiUiSettings` / singleton settings service foundation
...
**Wave 3 (blocked on Wave 2 completion)**
- [ ] 12-04-PLAN.md — `ChatDialogView`, `ChatSurfaceMounter`, header-button dialog toggle, route/menu gating
...
| 12. Configurable Chat Surfaces | 0/6 | Ready to execute | - |
