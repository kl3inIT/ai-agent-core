...
Still pending (not done): `../pending/2026-04-26-add-collapsible-tool-detail-and-ephemeral-status-to-chat-ui.md` — deferred (out of v1.1 scope per ROADMAP "Out of Scope").
