...
/**
 * Selection + action helpers for {@link DataGrid} components. Mirrors
 * {@code com.insurance.common.test_support_ui.DataGridInteractions}.
 */
public class DataGridInteractions<E> {
    ...
    public static <E, V extends View> DataGridInteractions<E> of(V view,
                                                                 Class<E> entityClass,
                                                                 String componentId) {
