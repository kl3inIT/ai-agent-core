 ...
 * that {@link AgentToolCallbacks#forCurrentUser()} exposes ONLY the 6 read tools and 2 link
 * tools. Mutation callbacks (create/update/add_related/remove_related) and the forbidden
 * {@code delete_record} (D-07 absolute) must be absent.
 *
 * <p>Count assertion is exact (8) because no production {@link com.vn.agent.spi.ToolContributor}
...
class AgentToolCallbacksDefaultConfigTest {
    ...
    void defaultConfig_exposesReadAndLinkToolsButNoMutationOrDelete() {
        ...
        // 6 read + 2 link callbacks should appear. If a future contributor is added, the
