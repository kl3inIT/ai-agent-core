 ...
 * Disabled until Phase 7 knowledge-base upload view lands; bodies filled in by 07-07b (Wave 5).
 */
@SpringBootTest
@Disabled("07-07b will enable once 07-06 knowledge upload view lands")
