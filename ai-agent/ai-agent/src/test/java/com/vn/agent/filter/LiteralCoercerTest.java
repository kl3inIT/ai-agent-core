...
class LiteralCoercerTest {
    ...
    private static MetaProperty datatypeProp(Class<?> javaClass, String name) {
        ...
        when(range.asDatatype()).thenReturn(dt);
        // Unchecked cast — javaClass is stored as Class<?>.
        @SuppressWarnings({"unchecked", "rawtypes"})
        Class raw = javaClass;
        when(dt.getJavaClass()).thenReturn(raw);
        return mp;
    }
    ...
    private static MetaProperty enumProp(Class<? extends Enum<?>> enumClass, String name) {
        ...
        @SuppressWarnings({"unchecked", "rawtypes"})
        Class raw = enumClass;
        when(enumeration.getJavaClass()).thenReturn(raw);
        return mp;
    }
    ...
    void coercesStringPassesThrough() {
        MetaProperty mp = datatypeProp(String.class, "name");
    ...
    void coercesUuidGood() {
        MetaProperty mp = datatypeProp(UUID.class, "id");
    ...
    void coercesLongFromNumber() {
        MetaProperty mp = datatypeProp(Long.class, "seq");
    ...
    void coercesIntegerFromNumber() {
        MetaProperty mp = datatypeProp(Integer.class, "qty");
    ...
    void coercesBigDecimalGood() {
        MetaProperty mp = datatypeProp(BigDecimal.class, "amount");
    ...
    void coercesBooleanFromBoolean() {
        MetaProperty mp = datatypeProp(Boolean.class, "active");
    ...
    void coercesLocalDateGood() {
        MetaProperty mp = datatypeProp(LocalDate.class, "birthday");
    ...
    void coercesLocalDateBad() {
        ...
        assertThatThrownBy(() -> coercer.coerce("01/15/2026", mp))
                ...
                .satisfies(e -> {
                    ToolUserError tue = (ToolUserError) e;
                    assertThat(tue.toDto().error()).isEqualTo("invalid_literal");
                    assertThat(tue.toDto().expected()).contains("YYYY-MM-DD");
                });
    }
    ...
    void coerceListWrapsEach() {
        MetaProperty mp = datatypeProp(Long.class, "ids");
